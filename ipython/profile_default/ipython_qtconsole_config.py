...
# variable IPYTHONDIR.
# c.IPythonQtConsoleApp.ipython_dir = u'/home/jtriley/.config/ipython'
...
# c.IPythonQtConsoleApp.log_format = '[%(name)s] %(message)s'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/home/jtriley/.config/ipython'
